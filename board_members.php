...
<div class="container-fluid">
        <div class="row">
            <h2 class="header2 text-center" style="margin: 40px auto 20px auto;">Board Members</h2>
        </div>
	</div>
    ...
    <div class="container board-members-section" style="padding: 20px 40px; margin-top: 40px;">
        ...
        <div class="row">
            <div class="img-container-left col-md-4">
                <div class="img-container">
                    <img class="img-responsive center-block" src="img/board_members/Stewart_Jim%20Hyperbaric_MG_9776%20vs3.JPG">
        ...
        <div class="row">
            <div class="img-container-right col-md-4">
                <div class="img-container">
                    <img class="img-responsive center-block" src="img/board_members/Gail.jpg">
                    <div class="board-members-img-text">
        ...
        <div class="row">
            <div class="img-container-left col-md-4">
                <div class="img-container">
                    <img class="img-responsive center-block" src="img/board_members/IMG_5870%20copy%20small.jpg">
                    <div class="board-members-img-text">
                        <p>VICE DIRECTOR<br>
                            Entrepreneur<br>
		...
		<div class="titlespacing">
        <div class="row">
            <h4 class="col-md-2 blueHeader text-center board-members-header-left">Becca Baggaley</h4>
            <div class="col-md-10 content-line"></div>
        </div>
		</div>
		<div class="sectionspacing">
        ...
        <div class="row">
            <div class="img-container-left col-md-4">
                <div class="img-container">
                    <img class="img-responsive center-block" src="img/board_members/black.jpg">
                    <div class="board-members-img-text">
                        <p>TREASURER<br>
                            Accountant</p>
                    </div>
        ...
        <div class="row">
            <div class="img-container-right col-md-4">
                <div class="img-container">
                    <img class="img-responsive center-block" src="img/board_members/DEnise.jpg">
                    <div class="board-members-img-text">
                        <p>FAMILY/COMMUNITY REPRESENTATIVE</p>
                    </div>
                </div>
            </div>
            <div class="col-md-8 board-members-text" style="float: right">
        ...
        <div class="row">
            <div class="img-container-left col-md-4">
                <div class="img-container">
                    <img class="img-responsive center-block" src="img/board_members/Bob%20Freeman.jpg">
                    <div class="board-members-img-text">
                        <p>WWII HISTORY CONSULTANT<br>
