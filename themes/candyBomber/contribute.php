...
<button onclick="topFunction()" id="myBtn" title="Go to top"><i class="fas fa-angle-up"></i>
    ...
    <div class="container">
        <div class="mission">
            <div class="row">
                <div class="col-sm-12">
                    <h2 class="header2">Contribute</h2>
                </div>
            </div>
        </div>
    </div>
	<div class="container" style="padding: 0 60px;">
        ...
        <p>
            ...
            <div class="col-md-12" style="margin-top:50px; margin-bottom: 50px">
                <a class="btn btn-primary btn-sm AboutButtonBlue center-block">BUY A BRICK</a>
    ...
    <div class="col-xs-12">
        ...
        <div class="container" style="padding: 20px 40px;">
            <div class="row">
                <h2 class="header2 text-center" style="margin: 40px auto 20px auto;">Our Golden Donors</h2>
            </div>
