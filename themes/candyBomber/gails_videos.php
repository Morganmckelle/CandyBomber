...
<button onclick="topFunction()" id="myBtn" title="Go to top"><i class="fas fa-angle-up"></i>
    ...
    <div class="container" style="padding: 20px 40px;">
        ...
        <div class="row videos" style="margin: 50px auto auto auto;">
                ...
                <h3 class="blueHeader text-center">Meet the Mormons</h3>
                <div>
                    <img class="img-responsive" src="img/gails-videos/meetmormons.JPG" data-toggle="modal" data-target="#Mormons" style="cursor: pointer;">
                </div>
                <p>Meet the Mormons: Gail S Halvorsen, the Candy Bomber </p><br><br><br><br>
                <a class="btn btn-primary btn-sm AboutButtonBlue center-block" data-toggle="modal" data-target="#Mormons">VIEW VIDEO</a>


                <!-- Modal -->
					     <div class="modal fade" id="Mormons" tabindex="-1" role="dialog" aria-labelledby="Mormons" aria-hidden="true">
                    <div id="modal-dialog" class="modal-dialog" role="document">
                        <div class="modal-content" >
                            ...
                            <div class="modal-body">
                                <iframe id="modal-iframe" class="modal-iframe" width="560" height="315" style="width:100%;" src="https://www.youtube.com/embed/NqnFT3hbLk" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                            </div>
            ...
            <div class="col-md-4" style="margin-bottom: 50px;">
                ...
                <p>History Documentary PBS: Gail Halvorsen - The Candy Bomber :the Berlin Airlift To children living in the rubble of post-war Germany.</p><br><br>
            ...
            <div class="col-md-4" style="margin-bottom: 50px;">
                ...
                <p>Tom Brokaw tells the story of Gail Halvorsen (The Candy Bomber) during the 2012 Mormon Tabernacle Choir Christmas Concert. </p><br><br><br>
		...
		<div class="row videos" style="margin: 50px auto auto auto;">
            <div class="col-md-4" style="margin-bottom: 50px;">
			   ...
			   <div class="col-md-4" style="margin-bottom: 50px;">
                <h3 class="blueHeader text-center">AFN Europe</h3>
                <img class="img-responsive"  src="img/gails-videos/AFNEurope.JPG" data-toggle="modal" data-target="#AFN" style="cursor: pointer;">
                <p>AFN Europe: SSgt John Archiquette takes us to Frankfurt, Germany, where one pilot returns to the nation that gave him his nickname: the Candy Bomber. </p>
                <a class="btn btn-primary btn-sm AboutButtonBlue center-block" data-toggle="modal" data-target="#AFN">VIEW VIDEO</a>


                <!-- Modal -->
                <div class="modal fade" id="AFN" tabindex="-1" role="dialog" aria-labelledby="AFN" aria-hidden="true">
                    <div id="modal-dialog" class="modal-dialog" role="document">
                        <div class="modal-content" >
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            ...
                            <div class="modal-body">
                                <iframe id="modal-iframe" class="modal-iframe" width="560" height="315" style="width:100%;" src="https://www.youtube.com/embed/dhWfEbjWoAU" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            </div>
