        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/slider/Gail-FenceFullslider.jpg" alt="Plane" class="img-responsive 1" />
                    <div class="carousel-caption">Welcome to the Gail S. Halvorsen Aviation Education Foundation</div>
                </div>
                <div class="item">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/slider/rendering.jpg" alt="Civil Air Patrol" class="img-responsive 2" />
                ...
                <div class="item">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/slider/candyDrop.jpg" alt="Candy Drop" class="img-responsive 3" />
            ...
            <div class="quicklinks">
                <div class="row">
                    <div class="col-md-4 quicklinksection">
                        <img class="img-responsive center-block" src="<?php echo get_template_directory_uri(); ?>/img/GailStory.jpg">
                    ...
                    <div class="col-md-4 quicklinksection">
                        <img class="img-responsive center-block" src="<?php echo get_template_directory_uri(); ?>/img/AviationEducationCenter.jpg">
                    ...
                    <div class="col-md-4 quicklinksection">
                        <img class="img-responsive center-block" src="<?php echo get_template_directory_uri(); ?>/img/Gail-FenceFull.jpg">
